...
// CSS modules removed - files don't exist
...
export function ForgotPasswordScreen() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4">
            ...
            >
                <Card
                    className="bg-white/10 backdrop-blur-md border border-[#B3E240]/30 rounded-2xl shadow-2xl relative overflow-hidden"
                    onMouseMove={handleMouseMove}
                    style={{
                        transform: `perspective(1000px) rotateX(${(mousePosition.y - 250) * 0.01}deg) rotateY(${(mousePosition.x - 400) * 0.01}deg)`,
                    }}
                >
                    <div
                        ...
                        style={{
                            background: `radial-gradient(600px circle at ${mousePosition.x}px ${mousePosition.y}px, rgba(179, 226, 64, 0.15), transparent 40%)`,
                        }}
                    />

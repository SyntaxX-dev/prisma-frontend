...
export function ProfileCompletionModal({
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            // Atualizar usuário no contexto: campos salvos + notificação recalculada
            if (user) {
                updateUser({
                    ...user,
            ...
            // Atualizar notificações na Navbar imediatamente
            ...
            // Redirecionar para o perfil (campo pendente concluído)
            router.push('/profile');
        } catch (error) {

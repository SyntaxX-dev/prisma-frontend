  ...
  return (
    <ClientOnly>
      ...
      <div className="flex items-center gap-2 md:gap-4 relative w-full">
        ...
        <div className="bg-white/15 backdrop-blur-md rounded-full px-3 md:px-4 py-2 md:py-3 border border-white/20 ml-auto md:ml-0 md:flex-1">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="pt-2 border-t border-white/20">
                          <Button
                            ...
                            className="w-full cursor-pointer bg-[#bd18b4] hover:bg-[#bd18b4]/90 text-black text-sm"
                          >
                            Completar Perfil
                          </Button>
                        </div>
        ...
        <DropdownMenu modal={false}>
          <DropdownMenuTrigger asChild>
            <div className="bg-white/15 backdrop-blur-md rounded-full px-2 md:px-4 py-2 border border-white/20 cursor-pointer hover:bg-white/20 transition-colors flex items-center gap-2 md:gap-3 flex-shrink-0">
